...
description: "Builds complete features spanning database, API, and frontend layers with end-to-end type safety and coordinated delivery across the full stack."
skills:
  - ai-engineer
  - analytics-reporter
  - api-tester
