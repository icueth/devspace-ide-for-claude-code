/**
 * Base CodeMirror 6 theme. Shared between the editor, diff view, and config editors.
 * Ported from claude_agent_teams_ui unchanged.
 */
...
export const baseEditorTheme = EditorView.theme({
  ...
  '.cm-tooltip-lint': { padding: '0', borderRadius: '6px', overflow: 'hidden' },
  '.cm-diagnostic': {
    padding: '6px 10px',
